      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between bg-gray-50 rounded-lg shadow-sm">
          ...
          <form
            ...
            action="https://sheetdb.io/api/v1/em65ljj2zvxh4">
              ...
              <button type="submit" onClick={handleSubmit} className="inline-flex items-center justify-center text-center px-4 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-500 hover:bg-indigo-600">
                Notify Me
              </button>
              </div>
              <div className="inline-flex rounded-md">
                <input name="data[Email]" className="w-80 pl-2 py-3 border-transparent text-base font-medium rounded-md text-indigo-600 bg-white hover:bg-indigo-50"/>
