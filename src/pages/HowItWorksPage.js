...
export default function HowItWorksPage() {
	return (
		<>
			...
			{/* ONBOARDING */}
			<div className="bg-gray-100 lg:px-8 px-4 py-20 sm:px-6">
				<div className="sm:flex sm:flex-col sm:align-center">
					...
					<div className="flex justify-center mt-7">
						<p className="text-xl text-gray-500 text-center w-7/12">
							Realium onboards income-producing properties through
							acquisitions or partnerships. We then form an LLC
							for each property to split it into thousands of
							tokens. Purchasing a token makes you an active part
							owner of an LLC that manages the property.
						</p>
					</div>
			...
			{/* PURCHASING TOKENS */}
			<div className="lg:px-8 px-4 py-20 sm:px-6">
			...
			{/* TRADING TOKENS */}
			<div className="bg-gray-50 lg:px-8 px-4 py-20 sm:px-6">
				<div className="sm:flex sm:flex-col sm:align-center">
					<h2 className="text-4xl font-extrabold text-gray-900 text-center">
						Trading tokens
					</h2>
					<div className="flex justify-center mt-7">
						<p className="text-xl text-gray-500 text-center w-7/12">
							Once all the tokens in a property have been sold,
							Realium creates a secondary market for users to sell
							their tokens to other users. Tokens listed for sale
							will be added to the order book of each property.
							Token price fluctuates based on user demand.
						</p>
					</div>
			...
			{/* Realium fees */}
			<div className="bg-indigo-500 lg:px-8 px-4 py-20 sm:px-6">
				<div className="sm:flex sm:flex-col sm:align-center">
					<h2 className="text-4xl font-extrabold text-white text-center">
						Realium fees
					</h2>
					<div className="flex justify-center mt-7">
						<p className="text-white text-center w-7/12 text-xl leading-7 font-normal">
							Realium sells properties to users at a 6% premium of
							the acquisition cost. Realium collects a 1%
							transaction fee on all secondary trades between
							users.
						</p>
					</div>
