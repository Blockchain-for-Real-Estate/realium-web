      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        ...
        <div className="border-t border-gray-200 pt-8 lg:flex lg:items-center lg:justify-between xl:mt-0">
          <div className="text-sm leading-5 font-normal text-gray-400">
            ...
            broker-dealer or investment advisor. Nothing on this website should
            be construed as an offer to sell, solicitation of an offer to buy or
            a recommendation in respect of a security. Any investment-related
            information presented below has been obtained from sources Realium
            believes to be trustworthy, but we make no claims or assurances as
            to its accuracy or completeness, and we accept no liability as a
            result. Based on your personal investing objectives, financial
            circumstances, and risk tolerance, you are solely responsible for
            determining whether any investment, investment plan, or associated
            transaction is appropriate for you. <br />
            <br />
            Past results are no guarantee of future outcomes. Returns in the
            past, predicted returns in the future, and probability forecasts may
            not reflect actual future performance. All real estate entails risk,
            and it is possible to lose all or part of your investment. Realium
            investors recognize and accept the following: 1) that investing in
            real estate, like investing in other fields, is risky and
            unpredictable; 2) that the real estate industry has its ups and
            downs; 3) that the real property you invest in may not generate a
            positive cash flow or perform as expected; and 4) that the value of
            any real property you invest in may decline at any time and the
            future property value is unpredictable. Prospective investors should
            carefully study the provided financial information of each property
            and consult with their tax, legal, and financial advisors before
            making an investment decision in any offering. Realium does not
            provide investment advice or make recommendations in connection with
            any of the offerings on the website.
          </div>
        </div>
