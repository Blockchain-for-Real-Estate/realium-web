          ...
          {listing.listingType === "Residential" ? (
            <div className="relative">
              ...
              <span className="absolute right-1 top-3 px-2 py-1 mr-2 h-7">
                ...
                >
                  <path
                    d="M0 4C0 1.79086 1.79086 0 4 0H40C42.2091 0 44 1.79086 44 4V16C44 18.2091 42.2091 20 40 20H4C1.79086 20 0 18.2091 0 16V4Z"
                    fill="#EDE9FE"
                  />
                  <path
                    d="M16.0536 5.27273H14.7496V11.6818H14.6687L10.2283 5.27273H9.00959V14H10.3263V7.59943H10.4073L14.8434 14H16.0536V5.27273ZM20.6932 14.1321C22.1207 14.1321 23.1307 13.429 23.4205 12.3636L22.2145 12.1463C21.9844 12.7642 21.4304 13.0795 20.706 13.0795C19.6151 13.0795 18.8821 12.3722 18.848 11.1108H23.5014V10.6591C23.5014 8.29403 22.0866 7.36932 20.6037 7.36932C18.7798 7.36932 17.5781 8.75852 17.5781 10.7699C17.5781 12.8026 18.7628 14.1321 20.6932 14.1321ZM18.8523 10.1562C18.9034 9.22727 19.5767 8.42188 20.6122 8.42188C21.6009 8.42188 22.2486 9.15483 22.2528 10.1562H18.8523ZM26.3224 14H27.6179L28.9474 9.27415H29.0455L30.375 14H31.6747L33.5966 7.45455H32.2798L31.0057 12.2401H30.9418L29.6634 7.45455H28.3466L27.0597 12.2614H26.9957L25.7131 7.45455H24.3963L26.3224 14Z"
                    fill="#5B21B6"
                  />
                </svg>
              </span>
