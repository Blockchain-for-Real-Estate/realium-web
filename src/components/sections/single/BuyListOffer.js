              ...
              <div className="border-t-2 border-gray-100 rounded-b-lg pt-8 pb-1 px-6 bg-white shadow-md sm:px-10 sm:py-10">
                <div className="m-2">
                  <h4 className="font-semibold text-lg">
                    Listing your current shares
                  </h4>
                  <p className="text-sm">
                    List your shares on the Realium marketplace. The listing
                    will show up when someone selects to purchase more shares.
                    Once your shares are listed, they are locked at their
                    current price.
                  </p>
                </div>
                {/* List form  */}
